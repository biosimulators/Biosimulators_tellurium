...
class CliTestCase(unittest.TestCase):
    ...
    def test_build_docker_image(self):
        ...
        # build image
        image_repo = 'ghcr.io/biosimulators/biosimulators_tellurium/tellurium'
    ...
    def test_sim_with_docker_image(self):
        ...
        os.makedirs(os.path.join(out_dir, 'ex1', 'BIOMD0000000297'))
        os.makedirs(os.path.join(out_dir, 'ex2', 'BIOMD0000000297'))

        # copy model and simulation to temporary directory which will be mounted into container
        shutil.copyfile('tests/fixtures/BIOMD0000000297.omex', os.path.join(in_dir, 'BIOMD0000000297.omex'))
    ...
    def test_validator(self):
        ...
        valid_cases, case_exceptions, _ = validator.run('ghcr.io/biosimulators/biosimulators_tellurium/tellurium', 'biosimulators.json')
