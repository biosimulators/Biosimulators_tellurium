...
Information about how to create COMBINE/OMEX archives which can be executed by BioSimulators-tellurium is available `here <`https://docs.biosimulations.org/users/creating-projects/>`_.
